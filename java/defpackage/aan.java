...
public final class aan {
    public static <T extends aam> String a(T t) {
        String str;
        String valueOf;
        if (t == null) {
            return "";
        ...
        try {
            aan.a(null, t, new StringBuffer(), stringBuffer);
    ...
    private static void a(String str, Object obj, StringBuffer stringBuffer, StringBuffer stringBuffer2) throws IllegalAccessException, InvocationTargetException {
        if (obj != null) {
            if (obj instanceof aam) {
                ...
                if (str != null) {
                    stringBuffer2.append(stringBuffer).append(aan.a(str)).append(" <\n");
                    stringBuffer.append("  ");
                }
                ...
                for (Field field : cls.getFields()) {
                    ...
                    if (!("cachedSize".equals(name) || (modifiers & 1) != 1 || (modifiers & 8) == 8 || name.startsWith("_") || name.endsWith("_"))) {
                        ...
                        if (!type.isArray()) {
                            aan.a(name, obj2, stringBuffer, stringBuffer2);
                        } else if (type.getComponentType() == Byte.TYPE) {
                            aan.a(name, obj2, stringBuffer, stringBuffer2);
                        } else {
                            int length2 = obj2 == null ? 0 : Array.getLength(obj2);
                            for (modifiers = 0; modifiers < length2; modifiers++) {
                                aan.a(name, Array.get(obj2, modifiers), stringBuffer, stringBuffer2);
                            }
                        }
                    }
                }
                        ...
                        try {
                            ...
                            if (((Boolean) cls.getMethod(name3.length() != 0 ? name.concat(name3) : new String(name), new Class[0]).invoke(obj, new Object[0])).booleanValue()) {
                                try {
                                    name = "get";
                                    name3 = String.valueOf(substring);
                                    aan.a(substring, cls.getMethod(name3.length() != 0 ? name.concat(name3) : new String(name), new Class[0]).invoke(obj, new Object[0]), stringBuffer, stringBuffer2);
            ...
            if (obj instanceof String) {
                stringBuffer2.append("\"").append(aan.b((String) obj)).append("\"");
            } else if (obj instanceof byte[]) {
                aan.a((byte[]) obj, stringBuffer2);
            } else {
