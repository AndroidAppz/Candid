...
class he$2 implements OnClickListener {
    final /* synthetic */ Comment a;
    final /* synthetic */ he b;

    he$2(he this$0, Comment comment) {
        this.b = this$0;
        this.a = comment;
    }
    ...
    public void onClick(View v) {
        if (this.a.messaging_blocked != null) {
            ...
            new Builder(this.b.f).setTitle("Message User?").setMessage("Would you like to send this user a message?").setNegativeButton(this.b.f.getResources().getString(2131230887), null).setPositiveButton(this.b.f.getResources().getString(2131230945), new he$2$1(this)).create().show();
