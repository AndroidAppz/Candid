...
public abstract class ady$a extends Binder implements ady {
    public static ady a(IBinder iBinder) {
        if (iBinder == null) {
            return null;
        }
        ...
        return (queryLocalInterface == null || !(queryLocalInterface instanceof ady)) ? new ady$a$a(iBinder) : (ady) queryLocalInterface;
    }
