...
public abstract class adx$a extends Binder implements adx {
    public static adx a(IBinder iBinder) {
        ...
        return (queryLocalInterface == null || !(queryLocalInterface instanceof adx)) ? new adx$a$a(iBinder) : (adx) queryLocalInterface;
    }
