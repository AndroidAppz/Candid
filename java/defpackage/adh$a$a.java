...
class adh$a$a implements adh {
    private IBinder a;

    adh$a$a(IBinder iBinder) {
        this.a = iBinder;
    }
    ...
    public zy a(zy inflaterWrapper, zy containerWrapper, Bundle savedInstanceState) throws RemoteException {
    ...
    public void a(zy activityWrapper, StreetViewPanoramaOptions options, Bundle savedInstanceState) throws RemoteException {
        Parcel obtain = Parcel.obtain();
        Parcel obtain2 = Parcel.obtain();
        try {
            obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate");
