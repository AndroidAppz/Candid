...
final class DistinguishedNameParser {
    ...
    private char getEscaped() {
        ...
        switch (this.chars[this.pos]) {
            ...
            case ha$a.AppCompatTheme_editTextColor /*62*/:
            case ha$a.AppCompatTheme_alertDialogButtonGroupStyle /*92*/:
            case ha$a.AppCompatTheme_textColorAlertDialogListItem /*95*/:
    ...
    private int getByte(int position) {
        ...
        if (b1 >= 48 && b1 <= 57) {
            b1 -= 48;
        } else if (b1 >= 97 && b1 <= ha$a.AppCompatTheme_checkboxStyle) {
            b1 -= 87;
        } else if (b1 < 65 || b1 > 70) {
            throw new IllegalStateException("Malformed DN: " + this.dn);
        } else {
        ...
        if (b2 >= 48 && b2 <= 57) {
            b2 -= 48;
        } else if (b2 >= 97 && b2 <= ha$a.AppCompatTheme_checkboxStyle) {
            b2 -= 87;
        } else if (b2 < 65 || b2 > 70) {
            throw new IllegalStateException("Malformed DN: " + this.dn);
        } else {
